...
/**
 * ข้อความบนป้ายระดับความเสี่ยง เช่น "เสี่ยง · 43"
 * จุดที่ยังไม่มีสถิติแสดง "ยังไม่มีสถิติ" แทนเลข 0 เพราะผู้ใช้จะเข้าใจว่าปลอดภัย
 */
export function formatRiskLabel(riskLevel, score, hasStatistics = true) {
  return `${riskLevel.label} · ${hasStatistics ? score : 'ยังไม่มีสถิติ'}`;
}
